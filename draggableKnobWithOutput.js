export class KnobWithOutpu {
  constructor(
    ...
    this.step = (this.drMax - this.drMin) / (this.maxNum - this.minNum);
  ...
  rotate = (angle) => {
    ...
    //change numbers in output
    this.output.innerText = Math.floor((newAngle - this.drMin) / this.step);
